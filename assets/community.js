(()=>{
  ...
  function modernNav(){
    ...
    community.id='rrNavAccount';community.textContent='Login';community.classList.add('rr-nav-login');
  ...
  function decorateChat(){
    ...
    const avatar=document.createElement('img');avatar.className='rr-advocate-avatar';avatar.src='assets/advocate.svg';avatar.alt='RightsRadar advocate';
    head.prepend(avatar);
    const h=head.querySelector('h2');if(h)h.textContent='RightsRadar Advocate Chat';
  }
  modernNav();
